...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/epic-generator.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/epic-generator.js":
/*!*******************************!*\
  !*** ./src/epic-generator.js ***!
  \*******************************/
/*! exports provided: default, otherColor, csv, exportCSV */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "otherColor", function() { return otherColor; });
...
/* harmony import */ var _classes_field_group__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./classes/field-group */ "./src/classes/field-group.js");
/* harmony import */ var _classes_color__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./classes/color */ "./src/classes/color.js");
/* harmony import */ var _classes_output__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./classes/output */ "./src/classes/output.js");





var fs = __webpack_require__(/*! @skpm/fs */ "./node_modules/@skpm/fs/index.js"); // documentation: https://developer.sketchapp.com/reference/api/


var document = __webpack_require__(/*! sketch/dom */ "sketch/dom").getSelectedDocument();

/* harmony default export */ __webpack_exports__["default"] = (function () {
  this.office = new _classes_field_group__WEBPACK_IMPORTED_MODULE_1__["default"](document, 'office').outputText();
  this.partnerCode = new _classes_field_group__WEBPACK_IMPORTED_MODULE_1__["default"](document, 'partner-code').outputText();
  this.reporter = new _classes_field_group__WEBPACK_IMPORTED_MODULE_1__["default"](document, 'reporter').outputText();
  this.assetLink = new _classes_field_group__WEBPACK_IMPORTED_MODULE_1__["default"](document, 'asset-link').outputText();
  this.primaryColor = new _classes_color__WEBPACK_IMPORTED_MODULE_2__["default"](document, 'primary').localColor().slice(0, -2);
  this.secondaryColor = new _classes_color__WEBPACK_IMPORTED_MODULE_2__["default"](document, 'secondary');
  this.tertiaryColor = new _classes_color__WEBPACK_IMPORTED_MODULE_2__["default"](document, 'tertiary');
  this.exportCSV();
});
function otherColor() {
  var output = [this.secondaryColor.localColor().slice(0, -2)];
...
function csv() {
  ...
  var text = __webpack_require__(/*! ./views/epic_template.csv */ "./src/views/epic_template.csv").replace('file://', '');

  var file = fs.readFileSync(text, {
    encoding: 'utf8'
  });
  var data = {
...
function exportCSV() {
  ...
  var filename = outputDirectory + "/" + this.partnerCode + ".csv";

  var text = __webpack_require__(/*! ./jira_es_config.txt */ "./src/jira_es_config.txt").replace('file://', '');

  var configData = fs.readFileSync(text, {
    encoding: 'utf8'
  });
  var configFilename = outputDirectory + "/jira_es_config.txt";
...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/317c50962af79dff00398c7b26619f9a.txt";

/***/ }),

/***/ "./src/views/epic_template.csv":
/*!*************************************!*\
  !*** ./src/views/epic_template.csv ***!
  \*************************************/
/*! no static exports found */
